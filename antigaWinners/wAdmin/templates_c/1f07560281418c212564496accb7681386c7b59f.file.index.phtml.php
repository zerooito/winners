<?php /* Smarty version Smarty-3.1.16, created on 2014-05-04 18:05:14
...
<?php if ($_valid && !is_callable('content_52d5674810eee0_62102266')) {function content_52d5674810eee0_62102266($_smarty_tpl) {?><!DOCTYPE html>
<html lang="pt">
  <head>
    <meta charset="utf-8">
          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="pagina_site.php">Paginas</a></li>
                <li><a href="#">Logo</a></li>
 ...
 <b class="caret"></b></a>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Dashboard <small>Pagina Inicial</small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-dashboard"></i> Dashboard</li>
            </ol>
            <div class="alert alert-success alert-dismissable">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              Bem vindo ao WAdmin <a class="alert-link" href="#">Avalie nosso Trabalho</a>! Sistema de controle total de empresa, seja ela um e-commerce, site, blog, escola, tudo o que sua empresa precisa ela encotra aqui. para saber mais clique <a href="#">Aqui</a>
            </div>
            <div class="alert alert-warning alert-dismissable">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              A url para acessar o seu site na rede é: <a class="alert-link" target="_blank" href="../site_front/index.php?id=<?php echo $_smarty_tpl->tpl_vars['id_usuario']->value;?>
">www.winnersdesenvolvimento.com.br/site_front/index.php?id=<?php echo $_smarty_tpl->tpl_vars['id_usuario']->value;?>
</a>. Não gostou deste endereço ? entre em contato com a gente e saiba como ter seu proprio dominio jr.design_2010@hotmail.com
            </div>
          </div>
        </div><!-- /.row -->
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text">Mensagens enviadas!</p>
                  </div>
                </div>
              </div>
              <a href="#">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text">Atividades Enviadas</p>
                  </div>
                </div>
              </div>
              <a href="#">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text">Notas Add</p>
                  </div>
                </div>
              </div>
              <a href="#">
...
<div class="col-lg-4">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-clock-o"></i> Agenda</h3>
              </div>
          ...
          <div class="col-lg-4">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-money"></i> Aulas Recentes</h3>
              </div>
              <div class="panel-body">
