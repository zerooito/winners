...
<form role="form" action="/banner/s_editar_cadastro/<?php echo $banner['Banner']['id'] ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <label>Nome</label>
                                    <input class="form-control" name="dados[nome_banner]" value="<?php echo $banner['Banner']['nome_banner'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control js-example-basic-single" name="dados[categoria_banner_id]">
                                    ...
                                    <option 
                                        ...
                                        <?php if ($categoria['CategoriaBanner']['id'] == $banner['Banner']['categoria_banner_id']): ?>
                                            selected
                                        <?php endif; ?>
                                    >
