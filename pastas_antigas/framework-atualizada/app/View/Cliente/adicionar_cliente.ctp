                    ...
                    <form role="form" action="/cliente/s_adicionar_cliente" method="post">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>CPF</label>
                                    <input class="form-control" name="dados[documento1]">
                                </div>                                
                                <div class="form-group">
                                    <label>RG</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="dados[data_de_nascimento]">
                                </div>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <button type="reset" class="btn btn-danger">Resetar Formulario</button>
                    </form>
                    <!-- /.row (nested) -->
                </div>
                <!-- /.panel-body -->
