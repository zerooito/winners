...
CREATE TABLE `caixas` (
  ...
  `valor_final_total` decimal(10,4) DEFAULT NULL,
  `valor_final_cartao` decimal(10,4) DEFAULT NULL,
  `valor_final_dinheiro` decimal(10,4) DEFAULT NULL,
  `valor_final_outros` decimal(10,4) DEFAULT NULL,
  `ativo` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
