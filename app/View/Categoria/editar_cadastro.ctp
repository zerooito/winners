...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Categoria <?php echo $dados['Categoria']['nome'] ?>- Editar cadastro</h1>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default" style="margin-top: 12px;">
                ...
                <div class="panel-body">
                    <form role="form" action="/categoria/s_editar_cadastro/<?php echo $dados['Categoria']['id'] ?>" method="post">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Nome</label>
                                    <input class="form-control" name="dados[nome]" value="<?php echo $dados['Categoria']['nome'] ?>">
